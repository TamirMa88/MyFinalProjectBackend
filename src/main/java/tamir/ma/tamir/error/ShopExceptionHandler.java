...
public class ShopExceptionHandler {
    ...
    @ExceptionHandler(tamir.ma.tamir.error.ResourceNotFoundException.class)
    public ProblemDetail handleResourceNotFoundException(tamir.ma.tamir.error.ResourceNotFoundException e) {
    ...
    public ProblemDetail handleBlogException(ShopException e) {
        var problemDetail =
                ProblemDetail.
